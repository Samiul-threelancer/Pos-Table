...
// const Electron = () => {
//     var {PosPrinter} = require("electron-pos-printer");
//     var {PosPrinter} = require('electron').remote.require("electron-pos-printer");
//     const options = {
//         preview: false,
//         margin: '0 0 0 0',
//         copies: 1,
...
//             // list of the columns to be rendered in the table header
//             tableHeader: [{type: 'text', value: 'People'}, {type: 'image'}],
//             // multi-dimensional array depicting the rows and columns of the table body
//             tableBody: [
